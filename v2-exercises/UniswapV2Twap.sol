...
contract UniswapV2Twap {
    ...
    constructor(address _pair) {
        ...
        pair = IUniswapV2Pair(address(_pair));
        ...
        returns (uint256 price0Cumulative, uint256 price1Cumulative)
    {
        ...
        if (blockTimestampLast != blockTimestamp) {
            ...
            uint32 dt = blockTimestamp - blockTimestampLast; // overflow is desired
    ...
    function update() external {
        ...
        uint32 dt = blockTimestamp - updatedAt; // overflow is desired
        // 3. Require time elapsed >= MIN_WAIT
        require(dt >= MIN_WAIT, "UniswapV2Twap::update: MIN_WAIT not elapsed");
        ...
        returns (uint256 amountOut)
    {
        ...
        require(tokenIn == token0 || tokenIn == token1, "UniswapV2Twap::consult: invalid token");
